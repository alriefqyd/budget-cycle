...
const ACTION_META = {
    ...
    'budget.exported': { label: 'Budget Exported', icon: 'download', color: 'text-primary' },
    'budget.auto_export_enabled': { label: 'Auto Backup Enabled', icon: 'schedule', color: 'text-tertiary' },
    'budget.auto_export_disabled': { label: 'Auto Backup Disabled', icon: 'schedule', color: 'text-on-surface-variant' },
